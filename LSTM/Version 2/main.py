...
if __name__ == "__main__":
    ...
    parser.add_argument('--person', type=str, default='Ester', help='Whose data to train the model on.')
    ...
    data = load_data(f'{DATA_PATH}{args.person}_train.txt', config)
    data_val = load_data(f'{DATA_PATH}{args.person}_val.txt' + , config)
